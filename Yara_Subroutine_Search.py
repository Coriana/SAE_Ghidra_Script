...
for r in ranges:
	...
	for line in lines:
		if line.startswith("0x"):
			...
			disassemble(begin.add(addr))
			createLabel(begin.add(addr), rule + "_" + str(begin.add(addr)), 0 )
##			cu = currentProgram.getListing().getUndefinedDataAt(begin.add(addr))
##			if cu == None:
